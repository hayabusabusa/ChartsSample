//
//  AverageBarChartViewModel.swift
//  ChartsSample
//
...
final class AverageBarChartViewModel {
...
extension AverageBarChartViewModel: ViewModelType {
    ...
    func transform(input: AverageBarChartViewModel.Input) -> AverageBarChartViewModel.Output {
